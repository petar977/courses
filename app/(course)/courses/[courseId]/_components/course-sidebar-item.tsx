...
export const CourseSideBarItem = ({label,id,courseId,isCompleted,isLocked}: CourseSideBarItemProps) => {
    ...
    return (
        <button type="button" onClick={onClick} className={cn("flex items-center pl-6 gap-x-2 text-sm font-[500] transition-all hover:text-slate-600 hover:bg-slate-300/20",
